@push('title', 'Nuevo proyecto')
<div class="flex flex-col gap-6">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div class="space-y-1">
            <flux:heading size="xl">Nuevo proyecto</flux:heading>
            <flux:text class="text-sm">Registra un nuevo proyecto social.</flux:text>
        </div>
        ...
        <div class="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div class="space-y-1">
                    ...
                    <flux:text class="text-sm">Agrega los objetivos especificos del proyecto.</flux:text>
                </div>
